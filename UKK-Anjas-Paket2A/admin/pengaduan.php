        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($query)) { ?>
        			<tr>
        				...
        				<td><?php echo $r['tampilan']; ?></td>
        				<td><?php echo $r['status']; ?></td>
        				<td><a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Yes/No')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
        				...
        				<div id="more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
        					<div class="modal-content">
        						...
        						<div class="col s12 m6">
        							...
        							<p>Tampilan : <?php echo $r['tampilan']; ?></p>
