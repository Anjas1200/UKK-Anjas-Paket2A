<table class="responsive-table" border="2" style="width: 100%;">
	<tr>
		<td>
			<h4 class="white-text hide-on-med-and-down">Tulis Laporan</h4>
		</td>
		<td>
			<h4 class="white-text hide-on-med-and-down">Daftar Laporan</h4>
		</td>
	</tr>
	<tr>
		<td style="padding: 20px;">
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					<label></label>Jenis Laporan</label>
					<br>
				...
				while ($r = mysqli_fetch_assoc($pengaduan)) { ?>
					<tr>
						...
						<td>
							...
							<a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Yes/No')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a>
						</td>
	...
	if ($foto != "") {
		if (in_array($eks, $listeks)) {
			if ($size <= 100000) {
				...
				$query = mysqli_query($koneksi, "INSERT INTO pengaduan VALUES (NULL, '$tgl','$nik','" . $_POST['laporan'] . "','$nama','proses','$tampilan')");
		...
		$query = mysqli_query($koneksi, "INSERT INTO pengaduan VALUES (NULL,'$tgl','$nik','" . $_POST['laporan'] . "','noImage.png','proses','$tampilan')");
		if ($query) {
